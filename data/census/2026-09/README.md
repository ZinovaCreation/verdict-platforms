...
- `nonplatform_vocab_v2.txt` - vocabulary used to order the evaluation queue. It has no effect on the population or on any coverage figure.
...
Nothing in this dataset is an assessment of any platform. Inclusion means only that a third-party list or a mechanical GitHub condition placed the entry in the field VERDICT measures itself against. Method, adoption tests and known limitations: `docs/selection/population_definition_v1.md` in verdict-engine.
